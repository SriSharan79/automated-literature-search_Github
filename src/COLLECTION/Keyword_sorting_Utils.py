...
def get_subsets_of_size(input_list, num):
    """
    Generate all subsets of the given input list with the exact size of 'num'.
    
    Args:
        input_list (list): List of strings to generate subsets from.
        num (int): The size of each subset.
    ...
    subsets = list(itertools.combinations(input_list, num))
