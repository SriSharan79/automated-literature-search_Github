...
from DATA_ANALYSIS.Abstract_Analyzer import analyze_abstract
from COMMON.Excel_Utils import extract_column, get_corresponding_value
from COMMON.General_Utils import caluculate_time_taken, find_missing_elements
from COMMON.JSON_file_Utils import get_value_by_pair
...
from DATA_ANALYSIS.Pdf_File_processor import process_pdf_abstract, process_pdf_file, process_pdf_mode_file
sys.path.extend([
    r'src',
    r'src/COLLECTION',
    r'Working_Code',
