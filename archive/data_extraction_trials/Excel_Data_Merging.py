...
results_folder='/remotedata/U/DLR+kata_du/ALR DATA/Keywords_&_SearchPhrases/02_Analyzed_Data'
mf = DataAnalyzeManager(results_folder)
source_file= mf.excel_success

target_file='/remotedata/U/DLR+kata_du/ALR DATA/Keywords_&_SearchPhrases/publications_metadata.xlsx'
